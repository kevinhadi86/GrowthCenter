...
@section("content")
    ...
    <div class="jumbotron jumbotron-fluid home-2" data-aos="fade-right">
    ...
    <div class="jumbotron jumbotron-fluid home-3" style="background-color: transparent" data-aos="fade-left">
